...
public final class DialogUtils {
    ...
    public static SendBirdDialogFragment buildWarning(String title,
                                                      ...
                                                      String negativeButtonText,
                                                      View.OnClickListener negativeButtonListener) {
        int negativeButtonTextColor = R.color.sb_button_uncontained_text_color_cancel_light;
        int positiveButtonTextColor = R.color.sb_button_uncontained_text_color_alert_light;
        return new SendBirdDialogFragment.Builder()
                .setDialogWidth(dialogWidth)
                .setTitle(title)
